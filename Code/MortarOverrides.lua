-- Mortar Overrides
Mortar.GetMishapChance = HUDABombardMishapChance
Mortar.GetMishapDeviationVector = HUDABombardMishapDeviationVector
...
function Mortar:ValidatePos(aim_pt)
    ...
    local weapon = attacker:GetActiveWeapons(attacker)
